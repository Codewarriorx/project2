<tr class="cartItem">
	...
	<td><?php echo html_entity_decode($catalogValues['name']); ?><input type="hidden" value="<?php echo $cartValues['id']; ?>" name="itemID"></td>
	<td>
		<form method="post" action="cart.php">
			<input type="hidden" value="<?php echo $cartValues['id']; ?>" name="itemID">
